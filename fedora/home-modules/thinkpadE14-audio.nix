...
guardRole "thinkpadE14" {
  ...
  xdg.configFile = {
    "easyeffects/input/Thinkpad E14 Input Enchancement.json" = {
      text = builtins.toJSON inputPreset;
    };
    "easyeffects/output/Thinkpad E14 Output Enchancement.json" = {
      text = builtins.toJSON outputPreset;
    };
  };
}
