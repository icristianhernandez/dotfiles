You have complete permission to run these commands in plan mode, alongside any diagnostic commands needed to gather logs or inspect the system.

"""
You can access and use the next links? Try connecting to them and do a search in them.
