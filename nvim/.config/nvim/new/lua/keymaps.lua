...
-- save file
create_keymap({ "i", "x", "n", "s" }, "<C-s>", "<cmd>w<cr><esc>", { desc = "Save File" })
...
-- better up/down
create_keymap({ "n", "x" }, "j", "v:count == 0 ? 'gj' : 'j'", { desc = "Down", expr = true, silent = true })
create_keymap({ "n", "x" }, "<Down>", "v:count == 0 ? 'gj' : 'j'", { desc = "Down", expr = true, silent = true })
create_keymap({ "n", "x" }, "k", "v:count == 0 ? 'gk' : 'k'", { desc = "Up", expr = true, silent = true })
create_keymap({ "n", "x" }, "<Up>", "v:count == 0 ? 'gk' : 'k'", { desc = "Up", expr = true, silent = true })

-- https://github.com/mhinz/vim-galore#saner-behavior-of-n-and-n
create_keymap("n", "n", "'Nn'[v:searchforward].'zv'", { expr = true, desc = "Next Search Result" })
create_keymap("x", "n", "'Nn'[v:searchforward]", { expr = true, desc = "Next Search Result" })
create_keymap("o", "n", "'Nn'[v:searchforward]", { expr = true, desc = "Next Search Result" })
create_keymap("n", "N", "'nN'[v:searchforward].'zv'", { expr = true, desc = "Prev Search Result" })
create_keymap("x", "N", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
create_keymap("o", "N", "'nN'[v:searchforward]", { expr = true, desc = "Prev Search Result" })
