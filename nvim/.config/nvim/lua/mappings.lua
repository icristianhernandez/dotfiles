...
vim.keymap.set("n", "<leader><Tab>1", "1gt", create_opts("Go to tab 1"))
vim.keymap.set("n", "<leader><Tab>2", "2gt", create_opts("Go to tab 2"))
vim.keymap.set("n", "<leader><Tab>3", "3gt", create_opts("Go to tab 3"))
vim.keymap.set("n", "<leader><Tab>4", "4gt", create_opts("Go to tab 4"))
vim.keymap.set("n", "<leader><Tab>5", "5gt", create_opts("Go to tab 5"))
vim.keymap.set("n", "<leader><Tab>6", "6gt", create_opts("Go to tab 6"))
vim.keymap.set("n", "<leader><Tab>7", "7gt", create_opts("Go to tab 7"))
vim.keymap.set("n", "<leader><Tab>8", "8gt", create_opts("Go to tab 8"))
vim.keymap.set("n", "<leader><Tab>9", "9gt", create_opts("Go to tab 9"))
